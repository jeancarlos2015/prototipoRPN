...
@foreach($modelos as $modelo)
    ...
    <li class="breadcrumb-item active"><a href="{!! route('controle_modelos_diagramaticos_index',[$modelo->codmodelo]) !!}"><i class="fa fa-eye"></i> Modelo: {!! $modelo->modelo->nome !!}</a></li>
    @break
@endforeach
...
<div class="card text-white o-hidden h-100" style="background-color: #0b2e13">
    <div class="card-body">
        ...
        <div class="mr-5 text-center"> {!! count($modelos)!!} DIAGRAMAS</div>
    </div>
