...
<li class="breadcrumb-item"><a href="{!! route('controle_modelos_index',[$modelo->codprojeto]) !!}"><i class="fa fa-eye"></i> Modelo: {!! $modelo->nome !!}</a></li>
<li class="breadcrumb-item"><a href="{!! route('controle_modelos_diagramaticos_index',[$modelo->codmodelo]) !!}"> <i class="fa fa-eye"></i> Diagramas</a></li>

<li class="breadcrumb-item active"><a  href="#" > <i class="fa fa-pencil"></i> Criação de Diagramas</a></li>
...
<div class="card text-white o-hidden h-100" style="background-color: #0b2e13">
    <div class="card-body">
        ...
        <div class="mr-5 text-center">NOVO DIAGRAMA BPMN </div>
    </div>
